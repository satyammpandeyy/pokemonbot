...
module.exports = {
    ...
    run: async (client, interaction, args, color, prefix) => {
        ...
        let embed = new MessageEmbed()
            ...
            .setDescription(`To see a page, just add the page number after the \`${prefix}help\` command.\nLike this: \`${prefix}help 2\`\n\n${client.user.username}'s Support Server: https://discord.gg/xW4xRGPtHv`)
            .addField("Page 1 | Home!", `Check out all sections in help menu! `)
            .addField("Page 2 | Getting Started!", `What you'll need to know to start using ${client.user.username}.`)
            .addField("Page 3 | Pokémon Commands!", `The core commands of the bot.`)
            .addField("Page 4 | Pokémon Commands II!", `The core commands of the bot.`)
            .addField("Page 5 | Shop, Market, Auction & Trading", `Commands to do with the shop and buying items.`)
            .addField("Page 6 | Settings", `Help configuring ${client.user.username} in your server.`)
            .addField("Page 7 | Miscellaneous", `Commands that don't really fit in anywhere else.`)
            .addField("Page 8 | Filters", 'Commands that help narrow down your serach results.')
            .addField("Page 9 | Aliases", 'All Shortforms for Above commands.')
            .setColor(color)

        let embed1 = new MessageEmbed()
            .setAuthor(client.user.username + " Help | Getting Started")
            .setDescription(`Welcome to ${client.user.username}! If you haven't started already, try using \`${prefix}start\` to find out how to get your first pokémon, then come back here and check out the other commands!\n${client.user.username}'s Support Server: https://discord.gg/xW4xRGPtHv`)
        ...
        let embed9 = new MessageEmbed()
            ...
            .addField(`${prefix}ricks add <amount>`, 'Add Balance Ricks to the ongoing Trade')
            .addField(`${prefix}ricks remove <amount>`, 'Removes Balance Rick(s) from the ongoing Trade')
        ...
        let auction = new MessageEmbed()
            .setAuthor("Auction Command")
            .setDescription("Auction your Pokemon and Let other trainers Bid for it.")
        ...
        interaction.followUp({ content: `**Help Menu:**` })
    }
}
